...
int main(void){
	JS_Number *var2 = new_number(1.25);
	JS_Number *var3 = var2;
	JS_Number *var4 = new_number(fabs(var3->value));
	JS_Number *var5 = var4;
	print_double(var5->value);
	JS_Number *var9 = new_number(1.26);
	JS_Number *var7 = new_number(fabs(var9->value));
	JS_Number *var10 = var7;
	print_double(var10->value);
	JS_Number *var14 = new_number(1.27);
	JS_Number *var12 = new_number(fabs(var14->value));
	print_double(var12->value);
}
